    ...
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <Button
          ...
          style={{ color: c.TEXT_MUTED, display: 'none' }} /* show only on mobile */
        />
        <div>
          <h1 style={{ margin: 0, fontSize: 20, fontWeight: 800, color: c.TEXT_BASE, lineHeight: 1.2 }}>
            {currentTitle[0]}
          </h1>
          <p style={{ margin: 0, fontSize: 12, color: c.TEXT_MUTED, fontWeight: 500 }}>
            {currentTitle[1]}
          </p>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
        ...
        <Tooltip title={
          <div style={{ fontSize: 11, lineHeight: 1.5 }}>
            ...
            <ul style={{ paddingLeft: 14, margin: '4px 0 0 0' }}>
              ...
              <li><code>ghar &gt;2000</code> (multiple filters combined)</li>
            </ul>
          </div>
        ...
        {/* 👁️ Privacy Mode (Hide/Show Amounts) */}
        <Button
          type="text"
          icon={hideAmounts ? <EyeInvisibleOutlined style={{ fontSize: 18, color: c.TEXT_MUTED }} /> : <EyeOutlined style={{ fontSize: 18, color: c.TEXT_MUTED }} />}
        ...
        <Badge count={alerts.length} size="small" offset={[-2, 2]}>
          <Button
            type="text"
            icon={<BellOutlined style={{ fontSize: 18, color: c.TEXT_MUTED }} />}
